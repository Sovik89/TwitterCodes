...
public class LinkedIn {
    ...
    private static String API_KEY = "81mgo2lbndn6yb";
    private static String API_SECRET = "d2CARKxPGDNxkfF3";
    ...
    public static void main(String[] args) {
        ...
        String url = "http://api.linkedin.com/v1/companies/36464/updates?start=20&count=10&format=json";
